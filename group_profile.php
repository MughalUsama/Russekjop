					...
					<div class="row justify-content-center">
						<div class="col-12 col-md-10 col-lg-8 col-xl-6">
							<form id="reg-form" class="login-form text-center" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
								...
								<div class="form-group mb-4 mb-lg-6">
									<input type="text" name="contactperson" value="<?php echo($_SESSION['userdata']['contact_person']); ?>" id="userContactPerson" class="form-control border border-danger" placeholder="Kontaktperson" required>
								</div>
								<div class="position-relative">
									<div class="form-group mb-4 mb-lg-6">
										<input type="text" name="telephone" value="<?php echo($_SESSION['userdata']['telephone']); ?>" id="userTelephone" class="form-control border border-danger" placeholder="Telefon" required>
									</div>
								</div>
								<div class="form-group mb-4 mb-lg-6">
								...
								<div class="form-group mb-4 mb-lg-6">
									<input type="text" name="address" id="userAddress" class="form-control border border-danger" value="<?php echo($_SESSION['userdata']['address']); ?>" placeholder="Adresse" required>
								</div>
								<div class="d-flex flex-row form-group mb-4 mb-lg-6">
									<input type="text" name="postcode" id="userPostCode" class=" form-control border border-danger" value="<?php echo($_SESSION['userdata']['post_code']); ?>" placeholder="Postkode" style="width: 65%;"  required>
									<input type="text" name="city" id="userCity" class=" form-control border border-danger" value="<?php echo($_SESSION['userdata']['city']); ?>" placeholder="Sted" style="margin-left:2.95%"  required>
								</div>
								<div class="form-group mb-4 mb-lg-6">
