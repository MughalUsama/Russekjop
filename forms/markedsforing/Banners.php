            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <form class="Banners-form text-center" method="POST" action="#">
                    <div class="d-flex flex-row justify-content-between form-group mb-5 mb-lg-6">
                        <input type="text" name="NumberOfBanners" id="NumberOfBanners" class=" form-control border border-danger col-4 d-flex justify-content-start" placeholder="Number of banners" required>
