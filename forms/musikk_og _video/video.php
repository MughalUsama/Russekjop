    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <form class="Video-form text-center" method="POST" action="#">
                    <div class="form-group mb-4 mb-lg-6">
                        <textarea name="paragraph_text_video" id="paragraph_text_video" cols="50" rows="10" class="form-control border border-danger" placeholder="Please provide us with additional information about your needs." required></textarea>
                    </div>
                    ...
                    <div class="pt-4 mb-5">
                        <button type="submit" name="sendVideo" id="sendVideo" class="btn btn-lg py-1 btn-danger text-capitalize font-weight-bold" style="float:right;margin-top: -5%;">Send</button>
                    </div>
                </form>
            </div>
        </div>
