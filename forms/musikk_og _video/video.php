            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <form class="Video-form text-center" method="POST" action="./forms/submit/detail7.php" enctype="multipart/form-data">
                    <div class="form-group mb-4 mb-lg-6">
                        <textarea name="description" id="paragraph_text_video" cols="50" rows="10" class="form-control border border-danger" placeholder="Vær vennlig å fyll inn tilleggsinformation om deres behov."></textarea>
                    </div>
