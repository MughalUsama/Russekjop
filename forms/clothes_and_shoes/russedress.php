            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <form class="Russedress-form text-center" method="POST" action="./forms/submit/detail1.php" enctype="multipart/form-data">
                    <div class="d-flex flex-row form-group mb-4 mb-lg-6">
                        <input type="number" name="quantity" id="numberOfRussedress" class=" form-control border border-danger" placeholder="Number of russedress" style="width: 50%;"  required>
                        <input type="text" name="color" id="colorOfRussedress" class=" form-control border border-danger" placeholder="Color" style="margin-left:2.95%;width:50%"  required>
                    </div>
                    <div class="d-flex flex-row form-group mb-4 mb-lg-6">
                        <input type="text" name="size" class="form-control border border-danger" id="sizeOfRussedress" placeholder="Size" style="width:48.5%">
                    </div>
