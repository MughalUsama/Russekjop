...
$query = "INSERT INTO `club_requests`(`club_id`, `category_id`, `product_id`, `description`, `filename`, `created_on`) VALUES (\"{$_SESSION["userdata"]["club_id"]}\",\"{$_SESSION["cat_id"]}\",\"{$_SESSION["pro_id"]}\",\"{$_SESSION["description"]}\",\"$newname\",\"$query_time\")";
