            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <form class="Caps-form text-center" method="POST" action="./forms/submit/detail1.php" enctype="multipart/form-data">
                    <div class="d-flex flex-row form-group mb-4 mb-lg-6">
                        <input type="text" name="quantity" id="numberOfCaps" class=" form-control border border-danger" placeholder="Number of caps" style="width: 33%;"  required>
                        ...
                        <select type="text" name="size" class="form-control border border-danger" id="sizeOfCaps" style="margin-left:2.95%;width:33%">
                    ...
                    <div class="form-group mb-4 mb-lg-6">
                        <textarea name="description" id="paragraph_text_Caps" cols="50" rows="10" class="form-control border border-danger" placeholder="Please provide us with additional information about your needs." required></textarea>
                    </div>
